  ...
  return withTailwind(
    <Page title="𝐶𝑜𝑛𝑛𝑜𝑟 𝑊ℎ𝑖𝑡𝑒">
      <Pattern opacity="0.03" fill="gray800" name="Circuit Board">
        <Tags.Div width="48" height="48" transform rotate="45" bgColor="gray800" marginLeft="-24" marginTop="-24" position="absolute" shadow="xl" />
        <Layout style={{ background: "linear-gradient(30deg, transparent, rgba(255,255,255,0.5))" }}>
          <Main>
            <Tags.Block width="10in12" paddingY="12" margin="auto" font="mono" sm={{ width: "11in12" }} md={{ paddingY: "16" }}>
              <picture>
              ...
              <br />
              <p>Connor also studied at the University of Texas where he received a Bachelor of Science in Electrical and Computer Engineering.</p>
              <br />
              <p paddingBottom="12">
